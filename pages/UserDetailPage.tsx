...
export const UserDetailPage: React.FC = () => {
  ...
  if (loading) return <div className="p-10 text-center text-slate-500">Loading Athlete Stats...</div>;
  if (!stats) return <div className="text-center py-20 text-slate-500">User not found</div>;
  ...
  return (
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <StatCard label="Consistency" value={`${stats.completionRate.toFixed(0)}%`} subValue="Completion Rate" />
        </div>
